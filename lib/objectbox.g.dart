...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 4651683134756184073),
      name: 'Site',
      lastPropertyId: const obx_int.IdUid(4, 4438463628605326977),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 299111572215435134),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3792890634884212803),
            name: 'name',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 1821383800312207509),
            name: 'location',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 4438463628605326977),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 4651683134756184073),
...
class Site_ {
  ...
  /// See [Site.name].
  static final name = obx.QueryStringProperty<Site>(_entities[0].properties[1]);

  /// See [Site.location].
  static final location =
      obx.QueryStringProperty<Site>(_entities[0].properties[2]);
